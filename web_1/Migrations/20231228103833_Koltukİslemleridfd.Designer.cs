...
namespace web_1.Migrations
{
    ...
    [Migration("20231228103833_Koltukİslemleridfd")]
    partial class Koltukİslemleridfd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("web_1.Models.Koltuklar", b =>
                {
                    ...
                    b.Property<int>("Firmarezervasyon_id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Firmarezervasyon_id");
            ...
            modelBuilder.Entity("web_1.Models.Koltuklar", b =>
                {
                    b.HasOne("web_1.Models.airline.Models.Rezervasyon", "Firma")
                        .WithMany("Koltuklars")
                        .HasForeignKey("Firmarezervasyon_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
